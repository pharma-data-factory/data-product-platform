...
2. **Create a composition manifest** under `catalog/compositions/` (`kind: GoldenPathComposition`, not a Catalog kind).
...
Reference proof: Machine Metrics (`catalog/compositions/machine-metrics-reference.yaml`).
Not OEE.
