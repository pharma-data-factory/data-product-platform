/**
 * Nexora Industrial Vocabulary — GP-8 extracted from platform-common.
 *
 * This is the canonical home for manufacturing and industrial domain types.
 * The content was previously in packages/platform-common/src/nexora-industrial.ts.
 *
 * platform-common re-exports everything from this package for backward
 * compatibility. New code should import directly from this package:
