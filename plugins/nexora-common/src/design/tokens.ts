...
export const nexoraThemeColor = {
  ...
  borderStrong: `var(--nexora-color-border-strong, ${nexoraColors.light.borderStrong})`,
  surface: `var(--nexora-color-surface, ${nexoraColors.light.surface})`,
  ...
  primary: `var(--nexora-color-primary, ${nexoraColors.light.primary})`,
  primaryContrast: `var(--nexora-color-primary-contrast, ${nexoraColors.light.primaryContrast})`,
  ...
  cardHover: `var(--nexora-color-card-hover, ${nexoraColors.light.cardHover})`,
  tableHeadBg: `var(--nexora-color-table-head, ${nexoraColors.light.tableHeadBg})`,
  cyanTint: `var(--nexora-color-cyan-tint, ${nexoraColors.light.cyanTint})`,
} as const;
