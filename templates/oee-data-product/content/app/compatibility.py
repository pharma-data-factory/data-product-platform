...
from app.contract import OEE_RESULT_VERSION, contract_file
...
def load_current_schema() -> dict[str, Any]:
    return load_json_schema(contract_file("oee-result.schema.json"))
...
def evaluate_compatibility(
    ...
    return shared_compatibility.evaluate_compatibility(
        ...
        consumers,
        contract=contract,
        default_version=OEE_RESULT_VERSION,
    )
